...
class PayfeeState extends State<Payfee> {
  bool choose = true;
  Payment payment;
  var cList;
    ...
    return Scaffold(
      ...
      body: Column(
        children: <Widget>[
          ...
          NextButton(
            text: "立即支付￥"+((20-moneyAmount)<=0?0.01:(20-moneyAmount)).toString()+" 元",
            onNext: (){
              if(isWechatInstalled){
                ApiRequest().payServiceFee(context,choose, widget.id, moneyAmount, couponId);
              }else{
